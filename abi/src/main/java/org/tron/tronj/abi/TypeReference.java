...
import org.tron.tronj.abi.datatypes.AbiTypes;
 ...
 */
public abstract class TypeReference<T extends org.tron.tronj.abi.datatypes.Type>
    ...
    public static <T extends org.tron.tronj.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
        return create(cls, false);
    }

    public static <T extends org.tron.tronj.abi.datatypes.Type> TypeReference<T> create(
     ...
     */
    protected static Class<? extends org.tron.tronj.abi.datatypes.Type> getAtomicTypeClass(
    ...
    public abstract static class StaticArrayTypeReference<T extends org.tron.tronj.abi.datatypes.Type>
    ...
    public static TypeReference makeTypeReference(
        ...
        if (!nextSquareBrackets.find()) {
            final Class<? extends org.tron.tronj.abi.datatypes.Type> typeClass =
        ...
        final Class<? extends org.tron.tronj.abi.datatypes.Type> baseClass =
        ...
        while (lastReadStringPosition < len) {
            ...
            if (arraySize == null || "".equals(arraySize)) {
                ...
                if (arraySizeInt <= StaticArray.MAX_SIZE_OF_STATIC_ARRAY) {
                    arrayclass =
                            Class.forName(
                                    "org.tron.tronj.abi.datatypes.generated.StaticArray" + arraySize);
                } else {
